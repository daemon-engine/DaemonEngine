...
public class Application : ApplicationBase
{
    ...
    public override void OnStart()
    {
        ...
        float[] vertices = new float[4 * (3 + 3)] {
        ...
        var shader = GraphicsFactory.CreateShader("Assets/Shaders/FlatColor.shader");
        ...
        _vertexBuffer = GraphicsFactory.CreateVertexBuffer(24 * sizeof(float), vertices);
