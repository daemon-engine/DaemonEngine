...
public interface IShader
{
    ...
    void SetFloat2(string name, Maths.Vector2 values);
    void SetFloat2(string name, float v0, float v1);
    void SetFloat3(string name, Maths.Vector3 values);
    void SetFloat3(string name, float v0, float v1, float v2);
    void SetMat4(string name, Matrix4x4 matrix, bool transpose = false);
    void SetMat4(string name, Maths.Matrix4 matrix, bool transpose = false);
}
